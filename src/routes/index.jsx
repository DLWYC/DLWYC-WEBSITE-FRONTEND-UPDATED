        ...
        <div className=" flex 2xl:basis-[45%] lg:basis-[60%] justify-center items-end lg:items-center lg:p-[10px] lg:h-full h-fit lg:mt-0 mt-[70px] ">
          <div className=" text-left grid 2xl:space-y-2 space-y-5 p-3 mt-10 ">
            ...
            <p className="font-grotesk text-text-paragraph leading-7 text-[15px] lg:w-[100%] ">
              ...
              <br />
              {/* <br /> */}
              Here, you’ll find everything from engaging contents and inspiring
              testimonies to event updates and service opportunities. Whether
              you’re seeking spiritual guidance, fellowship, or a place to get
              involved, this is where you can take your next steps in faith.
              Join us on this exciting journey as we grow together in Christ,
              strengthen our chaplaincy, and boldly live out our purpose. We’re
              glad you’re here. Let’s walk this journey of faith, service, and
...
As your Diocesan Chaplain, it is my prayer that through this space, you will be reminded of His unwavering love and your divine purpose.`}
      ...
      <div className="grid bg-[#f6f6f634] p-3">
        ...
        <div className="lg:p-5 grid place-content-center">
              <Button link="/events" text="View All" />
        </div>
      </div>
      {/* Events */}
